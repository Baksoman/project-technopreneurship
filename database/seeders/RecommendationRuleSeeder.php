...
class RecommendationRuleSeeder extends Seeder
{
    public function run(): void
    {
        $rules = [
            ...
            ['use_case' => 'gaming', 'category_slug' => 'cpu-cooler', 'budget_percentage' => 4, 'priority' => 6, 'scoring_weights' => ['performance' => 0.40, 'price_efficiency' => 0.40, 'tdp_efficiency' => 0.20]],
            ['use_case' => 'gaming', 'category_slug' => 'psu', 'budget_percentage' => 4, 'priority' => 7, 'scoring_weights' => ['performance' => 0.20, 'price_efficiency' => 0.50, 'tdp_efficiency' => 0.30]],
            ['use_case' => 'gaming', 'category_slug' => 'case', 'budget_percentage' => 2, 'priority' => 8, 'scoring_weights' => ['performance' => 0.10, 'price_efficiency' => 0.70, 'tdp_efficiency' => 0.20]],
            // EDITING
            ['use_case' => 'editing', 'category_slug' => 'cpu', 'budget_percentage' => 33, 'priority' => 1, 'scoring_weights' => ['performance' => 0.65, 'price_efficiency' => 0.20, 'tdp_efficiency' => 0.15]],
            ...
            ['use_case' => 'editing', 'category_slug' => 'cpu-cooler', 'budget_percentage' => 5, 'priority' => 6, 'scoring_weights' => ['performance' => 0.45, 'price_efficiency' => 0.35, 'tdp_efficiency' => 0.20]],
            ['use_case' => 'editing', 'category_slug' => 'psu', 'budget_percentage' => 2, 'priority' => 7, 'scoring_weights' => ['performance' => 0.20, 'price_efficiency' => 0.50, 'tdp_efficiency' => 0.30]],
            ['use_case' => 'editing', 'category_slug' => 'case', 'budget_percentage' => 0, 'priority' => 8, 'scoring_weights' => ['performance' => 0.10, 'price_efficiency' => 0.70, 'tdp_efficiency' => 0.20]],
            // WORK
            ['use_case' => 'work', 'category_slug' => 'cpu', 'budget_percentage' => 28, 'priority' => 1, 'scoring_weights' => ['performance' => 0.50, 'price_efficiency' => 0.35, 'tdp_efficiency' => 0.15]],
            ...
            ['use_case' => 'work', 'category_slug' => 'cpu-cooler', 'budget_percentage' => 4, 'priority' => 6, 'scoring_weights' => ['performance' => 0.35, 'price_efficiency' => 0.45, 'tdp_efficiency' => 0.20]],
            ['use_case' => 'work', 'category_slug' => 'psu', 'budget_percentage' => 3, 'priority' => 7, 'scoring_weights' => ['performance' => 0.20, 'price_efficiency' => 0.50, 'tdp_efficiency' => 0.30]],
            ['use_case' => 'work', 'category_slug' => 'case', 'budget_percentage' => 2, 'priority' => 8, 'scoring_weights' => ['performance' => 0.10, 'price_efficiency' => 0.70, 'tdp_efficiency' => 0.20]],
            // STUDY
            ['use_case' => 'study', 'category_slug' => 'cpu', 'budget_percentage' => 26, 'priority' => 1, 'scoring_weights' => ['performance' => 0.35, 'price_efficiency' => 0.55, 'tdp_efficiency' => 0.10]],
            ...
            ['use_case' => 'study', 'category_slug' => 'cpu-cooler', 'budget_percentage' => 4, 'priority' => 6, 'scoring_weights' => ['performance' => 0.30, 'price_efficiency' => 0.55, 'tdp_efficiency' => 0.15]],
            ['use_case' => 'study', 'category_slug' => 'psu', 'budget_percentage' => 3, 'priority' => 7, 'scoring_weights' => ['performance' => 0.15, 'price_efficiency' => 0.65, 'tdp_efficiency' => 0.20]],
            ['use_case' => 'study', 'category_slug' => 'case', 'budget_percentage' => 2, 'priority' => 8, 'scoring_weights' => ['performance' => 0.10, 'price_efficiency' => 0.70, 'tdp_efficiency' => 0.20]],
        ];
